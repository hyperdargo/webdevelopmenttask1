                ...
                <div class="row row-col-1 justify-content-center">
                    ...
                    <div class="form-group d-flex pl-2">
                        <div class="custom-control custom-radio">
                          ...
                          <label for="customRadio4" class="custom-control-label">Payment Details</label>
                          <p>Esewa- 9817051335</p>
                          <p>In Remark- Your Sign Up Email, First Name And Last Name.</p>
                        </div>
                      </div>
                        <div class="form-group col address-holder">
                            <label for="" class="control-label">Your Address</label>
                        ...
                        <h4 class="text-muted">Payment Method</h4>
                            <div class="d-flex w-100 justify-content-between">
                                <button class="btn btn-flat btn-primary">Pay</button>
