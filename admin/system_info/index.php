...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="yt_channel_id" class="control-label">Yotube ID <small><em>(enter your YT Channel ID)</em></small></label>
				<input type="text" class="form-control form-control-sm" name="yt_channel_id" id="yt_channel_id" value="<?php echo  $_settings->info('yt_channel_id') ?>">
			</div>
			<div class="form-group">
				<label for="yt_video_id" class="control-label">YT Featured Video ID</label>
				<input type="text" class="form-control form-control-sm" name="yt_video_id" id="yt_video_id" value="<?php echo  $_settings->info('yt_video_id') ?>">
			</div>
			<div class="form-group">
			...
			<div class="form-group d-flex justify-content-center">
				<img src="<?php echo validate_image($_settings->info('cover')) ?>" alt="" id="cimg2" class="img-fluid img-thumbnail bg-black">
			</div>
			</form>
		</div>
