<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid px-4 px-lg-5 d-flex justify-content-center ">
                ...
                <form class="form-inline" id="search-form">
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-outline-info btn-sm m-0" type="submit" id="button-addon2"><i class="fa fa-search"></i></button>
                    </div>
                  </div>
                </form>
