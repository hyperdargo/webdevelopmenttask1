...
<section class="py-3">
    <div class="container px-4 px-lg-5 mt-5">
        <h1 class="text-center text-default" style="font-family: 'Brush Script MT', cursive;">Featured Game</h1>
        ...
        <div class="mt-3 row gx-4 gx-lg-5 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <?php 
                $products = $conn->query("SELECT * FROM `products` where status = 1 and id in (SELECT product_id FROM `featured_game`) order by Rand() ");
